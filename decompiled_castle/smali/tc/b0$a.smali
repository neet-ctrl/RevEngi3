...
.method public constructor <init>(Ltc/b0;)V
    ...
    .line 1
    iput-object p1, p0, Ltc/b0$a;->a:Ltc/b0;
...
.method public bridge synthetic bind(Landroidx/sqlite/SQLiteStatement;Ljava/lang/Object;)V
    ...
    .line 2
    .line 3
    invoke-virtual {p0, p1, p2}, Ltc/b0$a;->a(Landroidx/sqlite/SQLiteStatement;Lcom/gxgx/daqiandy/room/entity/FilmEntity;)V
...
.method public createQuery()Ljava/lang/String;
    ...
    .line 1
    const-string v0, "INSERT OR ABORT INTO `FilmEntity` (`uid`,`userId`,`movieId`,`type`,`total`,`downloadPosition`,`title`,`publishTime`,`totalNumber`,`size`,`duration`,`countries`,`tags`,`coverHorizontalImage`,`coverVerticalImage`,`resolution`,`speed`,`episodeId`,`number`,`taskId`,`localFileName`,`localPath`,`state`,`movieParentId`,`m3U8TaskId`,`languageId`,`groupTaskId`,`abbreviate`,`isDefault`,`existIndividualVideo`,`languageName`,`progressPosition`,`playingPosition`,`downVideoUrl`,`titleHasEncode`,`episodeName`,`seasonNumber`) VALUES (nullif(?, 0),?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)"

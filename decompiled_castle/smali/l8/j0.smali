...
.method public static a(Ljava/lang/String;Ljava/util/concurrent/ExecutorService;)V
    ...
    .line 4
    .line 5
    invoke-static {p0, p1, v0, v1, v2}, Ll8/j0;->b(Ljava/lang/String;Ljava/util/concurrent/ExecutorService;JLjava/util/concurrent/TimeUnit;)V
...
.method public static b(Ljava/lang/String;Ljava/util/concurrent/ExecutorService;JLjava/util/concurrent/TimeUnit;)V
    ...
    .line 14
    invoke-direct/range {v2 .. v7}, Ll8/j0$b;-><init>(Ljava/lang/String;Ljava/util/concurrent/ExecutorService;JLjava/util/concurrent/TimeUnit;)V
...
.method public static c(Ljava/util/concurrent/Executor;)Ljava/util/concurrent/Executor;
    ...
    .line 1
    invoke-static {p0}, Lg8/z;->h(Ljava/util/concurrent/Executor;)Ljava/util/concurrent/Executor;
...
.method public static d(Ljava/lang/String;)Ljava/util/concurrent/ExecutorService;
    ...
    .line 1
    invoke-static {p0}, Ll8/j0;->f(Ljava/lang/String;)Ljava/util/concurrent/ThreadFactory;
    ...
    .line 9
    .line 10
    invoke-static {v0, v1}, Ll8/j0;->g(Ljava/util/concurrent/ThreadFactory;Ljava/util/concurrent/RejectedExecutionHandler;)Ljava/util/concurrent/ExecutorService;
    ...
    .line 14
    invoke-static {p0, v0}, Ll8/j0;->a(Ljava/lang/String;Ljava/util/concurrent/ExecutorService;)V
...
.method public static f(Ljava/lang/String;)Ljava/util/concurrent/ThreadFactory;
    ...
    .line 7
    .line 8
    new-instance v1, Ll8/j0$a;

    .line 9
    .line 10
    invoke-direct {v1, p0, v0}, Ll8/j0$a;-><init>(Ljava/lang/String;Ljava/util/concurrent/atomic/AtomicLong;)V

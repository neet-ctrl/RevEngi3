...
.method public constructor <init>(Landroid/content/Context;Lcom/revenuecat/purchases/identity/IdentityManager;Lga/b;Lwd/m0;Lwd/m0;)V
    .locals 1
    ...
    .line 3
    iput-object p3, p0, Lcom/revenuecat/purchases/blockstore/BlockstoreHelper;->blockstoreClient:Lga/b;

    .line 4
    iput-object p4, p0, Lcom/revenuecat/purchases/blockstore/BlockstoreHelper;->ioScope:Lwd/m0;

    .line 5
    iput-object p5, p0, Lcom/revenuecat/purchases/blockstore/BlockstoreHelper;->mainScope:Lwd/m0;

    return-void
.end method

.method public synthetic constructor <init>(Landroid/content/Context;Lcom/revenuecat/purchases/identity/IdentityManager;Lga/b;Lwd/m0;Lwd/m0;ILkotlin/jvm/internal/k;)V
    .locals 6
    ...
    invoke-virtual {p3, p1}, Lcom/revenuecat/purchases/blockstore/BlockstoreHelper$Companion;->initializeBlockstoreClient(Landroid/content/Context;)Lga/b;
    ...
    .line 7
    invoke-static {v0, p7, v0}, Lwd/s2;->b(Lwd/x1;ILjava/lang/Object;)Lwd/y;
    ...
    invoke-virtual {p4, p7}, Lwd/i0;->R0(I)Lwd/i0;

    move-result-object p4

    invoke-interface {p3, p4}, Lad/i;->k0(Lad/i;)Lad/i;
    ...
    .line 9
    invoke-direct/range {v0 .. v5}, Lcom/revenuecat/purchases/blockstore/BlockstoreHelper;-><init>(Landroid/content/Context;Lcom/revenuecat/purchases/identity/IdentityManager;Lga/b;Lwd/m0;Lwd/m0;)V

    return-void
.end method

.method public static final synthetic access$aliasCurrentAndStoredUserIdsIfNeeded$callCompletion(Lcom/revenuecat/purchases/blockstore/BlockstoreHelper;Lkd/a;)V
    .locals 0

    .line 1
    invoke-static {p0, p1}, Lcom/revenuecat/purchases/blockstore/BlockstoreHelper;->aliasCurrentAndStoredUserIdsIfNeeded$callCompletion(Lcom/revenuecat/purchases/blockstore/BlockstoreHelper;Lkd/a;)V
...
.method public static final synthetic access$getBlockstoreData(Lcom/revenuecat/purchases/blockstore/BlockstoreHelper;Lad/e;)Ljava/lang/Object;
    .locals 0

    .line 1
    invoke-direct {p0, p1}, Lcom/revenuecat/purchases/blockstore/BlockstoreHelper;->getBlockstoreData(Lad/e;)Ljava/lang/Object;
...
.method public static final synthetic access$storeUserIdIfNeeded(Lcom/revenuecat/purchases/blockstore/BlockstoreHelper;Ljava/util/Map;Ljava/lang/String;Lad/e;)Ljava/lang/Object;
    .locals 0

    .line 1
    invoke-direct {p0, p1, p2, p3}, Lcom/revenuecat/purchases/blockstore/BlockstoreHelper;->storeUserIdIfNeeded(Ljava/util/Map;Ljava/lang/String;Lad/e;)Ljava/lang/Object;
...
.method private static final aliasCurrentAndStoredUserIdsIfNeeded$callCompletion(Lcom/revenuecat/purchases/blockstore/BlockstoreHelper;Lkd/a;)V
    .locals 6
    ...
    .line 1
    iget-object v0, p0, Lcom/revenuecat/purchases/blockstore/BlockstoreHelper;->mainScope:Lwd/m0;
    ...
    .line 6
    invoke-direct {v3, p1, p0}, Lcom/revenuecat/purchases/blockstore/BlockstoreHelper$aliasCurrentAndStoredUserIdsIfNeeded$callCompletion$1;-><init>(Lkd/a;Lad/e;)V
...
.method private final getBlockstoreData(Lad/e;)Ljava/lang/Object;
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 1
    iget-object v0, p0, Lcom/revenuecat/purchases/blockstore/BlockstoreHelper;->blockstoreClient:Lga/b;
    ...
    .line 11
    .line 12
    invoke-direct {v1}, Lga/d$a;-><init>()V
    ...
    .line 16
    invoke-virtual {v1, v2}, Lga/d$a;->b(Z)Lga/d$a;
    ...
    .line 20
    invoke-virtual {v1}, Lga/d$a;->a()Lga/d;
    ...
    .line 37
    .line 38
    invoke-interface {v0, v1}, Lga/b;->c(Lga/d;)Lbb/i;
    ...
    .line 43
    .line 44
    invoke-direct {v1, v2}, Lcom/revenuecat/purchases/blockstore/BlockstoreHelper$getBlockstoreData$2$1;-><init>(Lad/e;)V
    ...
    .line 48
    .line 49
    invoke-direct {v3, v1}, Lcom/revenuecat/purchases/blockstore/BlockstoreHelper$sam$com_google_android_gms_tasks_OnSuccessListener$0;-><init>(Lkd/l;)V

    .line 50
    .line 51
    .line 52
    invoke-virtual {v0, v3}, Lbb/i;->f(Lbb/g;)Lbb/i;
    ...
    .line 57
    .line 58
    invoke-direct {v1, v2}, Lcom/revenuecat/purchases/blockstore/BlockstoreHelper$getBlockstoreData$2$2;-><init>(Lad/e;)V

    .line 59
    .line 60
    .line 61
    invoke-virtual {v0, v1}, Lbb/i;->d(Lbb/f;)Lbb/i;
...
.method private final storeUserIdIfNeeded(Ljava/util/Map;Ljava/lang/String;Lad/e;)Ljava/lang/Object;
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 26
    :cond_5
    new-instance p1, Lga/f$a;

    invoke-direct {p1}, Lga/f$a;-><init>()V
    ...
    invoke-virtual {p1, v2}, Lga/f$a;->b([B)Lga/f$a;

    move-result-object p1

    .line 28
    invoke-virtual {p1, v1}, Lga/f$a;->c(Ljava/lang/String;)Lga/f$a;
    ...
    .line 29
    invoke-virtual {p1, v1}, Lga/f$a;->d(Z)Lga/f$a;

    move-result-object p1

    .line 30
    invoke-virtual {p1}, Lga/f$a;->a()Lga/f;
    ...
    invoke-direct {v1, v2}, Lad/k;-><init>(Lad/e;)V

    .line 32
    invoke-interface {v0, p1}, Lga/b;->b(Lga/f;)Lbb/i;
    ...
    invoke-direct {v0, v1, p2}, Lcom/revenuecat/purchases/blockstore/BlockstoreHelper$storeUserIdIfNeeded$6$1;-><init>(Lad/e;Ljava/lang/String;)V
    ...
    invoke-direct {p2, v0}, Lcom/revenuecat/purchases/blockstore/BlockstoreHelper$sam$com_google_android_gms_tasks_OnSuccessListener$0;-><init>(Lkd/l;)V

    invoke-virtual {p1, p2}, Lbb/i;->f(Lbb/g;)Lbb/i;
    ...
    invoke-direct {p2, v1}, Lcom/revenuecat/purchases/blockstore/BlockstoreHelper$storeUserIdIfNeeded$6$2;-><init>(Lad/e;)V

    invoke-virtual {p1, p2}, Lbb/i;->d(Lbb/f;)Lbb/i;
...
# virtual methods
.method public final aliasCurrentAndStoredUserIdsIfNeeded(Lkd/a;)V
    .locals 8
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 24
    :cond_0
    iget-object v2, p0, Lcom/revenuecat/purchases/blockstore/BlockstoreHelper;->ioScope:Lwd/m0;
    ...
    .line 29
    invoke-direct {v5, p0, v0, p1, v1}, Lcom/revenuecat/purchases/blockstore/BlockstoreHelper$aliasCurrentAndStoredUserIdsIfNeeded$1;-><init>(Lcom/revenuecat/purchases/blockstore/BlockstoreHelper;Ljava/lang/String;Lkd/a;Lad/e;)V
...
.method public final clearUserIdBackupIfNeeded(Lkd/a;)V
    .locals 9
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 15
    .line 16
    invoke-direct {v1}, Lga/c$a;-><init>()V
    ...
    .line 25
    invoke-virtual {v1, v2}, Lga/c$a;->b(Ljava/util/List;)Lga/c$a;
    ...
    .line 29
    invoke-virtual {v1}, Lga/c$a;->a()Lga/c;
    ...
    .line 37
    .line 38
    iget-object v3, p0, Lcom/revenuecat/purchases/blockstore/BlockstoreHelper;->ioScope:Lwd/m0;
    ...
    .line 43
    invoke-direct {v6, v0, v1, p1, v2}, Lcom/revenuecat/purchases/blockstore/BlockstoreHelper$clearUserIdBackupIfNeeded$1;-><init>(Lga/b;Lga/c;Lkd/a;Lad/e;)V
...
.method public final storeUserIdIfNeeded(Lcom/revenuecat/purchases/CustomerInfo;)V
    ...
    .line 5
    :cond_1
    iget-object v1, p0, Lcom/revenuecat/purchases/blockstore/BlockstoreHelper;->ioScope:Lwd/m0;

    new-instance v4, Lcom/revenuecat/purchases/blockstore/BlockstoreHelper$storeUserIdIfNeeded$1;

    const/4 p1, 0x0

    invoke-direct {v4, p0, v0, p1}, Lcom/revenuecat/purchases/blockstore/BlockstoreHelper$storeUserIdIfNeeded$1;-><init>(Lcom/revenuecat/purchases/blockstore/BlockstoreHelper;Ljava/lang/String;Lad/e;)V

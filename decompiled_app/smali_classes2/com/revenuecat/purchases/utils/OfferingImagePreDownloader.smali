...
.method private final findImageUrisToDownload(Lcom/revenuecat/purchases/paywalls/components/StackComponent;)Ljava/util/Set;
    ...
    .line 17
    invoke-static {v3, v4}, Lxc/y;->D(Ljava/util/Collection;Ljava/lang/Iterable;)Z

    goto :goto_1

    .line 18
    :cond_0
    invoke-static {v2, v3}, Lxc/u0;->h(Ljava/util/Set;Ljava/lang/Iterable;)Ljava/util/Set;
    ...
    .line 43
    invoke-static {v4, v5}, Lxc/y;->D(Ljava/util/Collection;Ljava/lang/Iterable;)Z

    goto :goto_4

    .line 44
    :cond_9
    invoke-static {v2, v4}, Lxc/u0;->h(Ljava/util/Set;Ljava/lang/Iterable;)Ljava/util/Set;
...
.method private final findImageUrisToDownload(Lcom/revenuecat/purchases/paywalls/components/common/Background;)Ljava/util/Set;
    ...
    .line 59
    invoke-static {p1}, Lxc/t0;->f([Ljava/lang/Object;)Ljava/util/Set;

...
.field private final onSuccess:Lkd/p;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lkd/p;"
        }
...
# direct methods
.method public constructor <init>(Lcom/revenuecat/purchases/models/StoreProduct;Ljava/util/Date;Lkd/p;Lkd/l;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 27
    .line 28
    iput-object p3, p0, Lcom/revenuecat/purchases/amazon/handler/PurchaseHandler$PurchaseRequest;->onSuccess:Lkd/p;

    .line 29
    .line 30
    iput-object p4, p0, Lcom/revenuecat/purchases/amazon/handler/PurchaseHandler$PurchaseRequest;->onError:Lkd/l;
...
.method public static synthetic copy$default(Lcom/revenuecat/purchases/amazon/handler/PurchaseHandler$PurchaseRequest;Lcom/revenuecat/purchases/models/StoreProduct;Ljava/util/Date;Lkd/p;Lkd/l;ILjava/lang/Object;)Lcom/revenuecat/purchases/amazon/handler/PurchaseHandler$PurchaseRequest;
    .locals 0
    ...
    .line 16
    .line 17
    iget-object p3, p0, Lcom/revenuecat/purchases/amazon/handler/PurchaseHandler$PurchaseRequest;->onSuccess:Lkd/p;
    ...
    .line 22
    .line 23
    iget-object p4, p0, Lcom/revenuecat/purchases/amazon/handler/PurchaseHandler$PurchaseRequest;->onError:Lkd/l;

    .line 24
    .line 25
    :cond_3
    invoke-virtual {p0, p1, p2, p3, p4}, Lcom/revenuecat/purchases/amazon/handler/PurchaseHandler$PurchaseRequest;->copy(Lcom/revenuecat/purchases/models/StoreProduct;Ljava/util/Date;Lkd/p;Lkd/l;)Lcom/revenuecat/purchases/amazon/handler/PurchaseHandler$PurchaseRequest;
...
.method public final component3()Lkd/p;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    .line 1
    iget-object v0, p0, Lcom/revenuecat/purchases/amazon/handler/PurchaseHandler$PurchaseRequest;->onSuccess:Lkd/p;
...
.method public final component4()Lkd/l;
    ...
    .line 1
    iget-object v0, p0, Lcom/revenuecat/purchases/amazon/handler/PurchaseHandler$PurchaseRequest;->onError:Lkd/l;
...
.method public final copy(Lcom/revenuecat/purchases/models/StoreProduct;Ljava/util/Date;Lkd/p;Lkd/l;)Lcom/revenuecat/purchases/amazon/handler/PurchaseHandler$PurchaseRequest;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 22
    .line 23
    invoke-direct {v0, p1, p2, p3, p4}, Lcom/revenuecat/purchases/amazon/handler/PurchaseHandler$PurchaseRequest;-><init>(Lcom/revenuecat/purchases/models/StoreProduct;Ljava/util/Date;Lkd/p;Lkd/l;)V
...
.method public equals(Ljava/lang/Object;)Z
    ...
    .line 35
    :cond_3
    iget-object v1, p0, Lcom/revenuecat/purchases/amazon/handler/PurchaseHandler$PurchaseRequest;->onSuccess:Lkd/p;

    .line 36
    .line 37
    iget-object v3, p1, Lcom/revenuecat/purchases/amazon/handler/PurchaseHandler$PurchaseRequest;->onSuccess:Lkd/p;
    ...
    .line 46
    :cond_4
    iget-object v1, p0, Lcom/revenuecat/purchases/amazon/handler/PurchaseHandler$PurchaseRequest;->onError:Lkd/l;

    .line 47
    .line 48
    iget-object p1, p1, Lcom/revenuecat/purchases/amazon/handler/PurchaseHandler$PurchaseRequest;->onError:Lkd/l;
...
.method public final getOnSuccess()Lkd/p;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",

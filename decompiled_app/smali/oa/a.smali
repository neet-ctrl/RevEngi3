...
.field public static volatile c:Loa/a;
...
.method public constructor <init>()V
    ...
    .line 8
    .line 9
    iput-object v0, p0, Loa/a;->a:Ljava/util/concurrent/ConcurrentHashMap;
...
.method public static b()Loa/a;
    ...
    .line 4
    .line 5
    sget-object v0, Loa/a;->b:Ljava/lang/Object;
...
.method public static final h(Landroid/content/Context;Landroid/content/Intent;Landroid/content/ServiceConnection;ILjava/util/concurrent/Executor;)Z
    ...
    .line 11
    .line 12
    invoke-static {p0, p1, p3, p4, p2}, Lk8/d;->a(Landroid/content/Context;Landroid/content/Intent;ILjava/util/concurrent/Executor;Landroid/content/ServiceConnection;)Z
...
.method public a(Landroid/content/Context;Landroid/content/Intent;Landroid/content/ServiceConnection;I)Z
    ...
    .line 16
    invoke-virtual/range {v1 .. v8}, Loa/a;->e(Landroid/content/Context;Ljava/lang/String;Landroid/content/Intent;Landroid/content/ServiceConnection;IZLjava/util/concurrent/Executor;)Z
...
.method public c(Landroid/content/Context;Landroid/content/ServiceConnection;)V
    ...
    .line 1
    invoke-static {p2}, Loa/a;->f(Landroid/content/ServiceConnection;)Z
    ...
    .line 6
    .line 7
    iget-object v0, p0, Loa/a;->a:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    .line 20
    .line 21
    invoke-static {p1, v0}, Loa/a;->g(Landroid/content/Context;Landroid/content/ServiceConnection;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    .line 23
    .line 24
    iget-object p1, p0, Loa/a;->a:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    .line 37
    :cond_0
    invoke-static {p1, p2}, Loa/a;->g(Landroid/content/Context;Landroid/content/ServiceConnection;)V
...
.method public final d(Landroid/content/Context;Ljava/lang/String;Landroid/content/Intent;Landroid/content/ServiceConnection;ILjava/util/concurrent/Executor;)Z
    ...
    .line 10
    invoke-virtual/range {v0 .. v7}, Loa/a;->e(Landroid/content/Context;Ljava/lang/String;Landroid/content/Intent;Landroid/content/ServiceConnection;IZLjava/util/concurrent/Executor;)Z
...
.method public final e(Landroid/content/Context;Ljava/lang/String;Landroid/content/Intent;Landroid/content/ServiceConnection;IZLjava/util/concurrent/Executor;)Z
    ...
    .line 24
    invoke-virtual {v2, p6, v1}, Lqa/e;->c(Ljava/lang/String;I)Landroid/content/pm/ApplicationInfo;
    ...
    :cond_1
    :goto_0
    invoke-static {p4}, Loa/a;->f(Landroid/content/ServiceConnection;)Z
    ...
    .line 46
    .line 47
    iget-object p6, p0, Loa/a;->a:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    :cond_2
    :try_start_1
    invoke-static {p1, p3, p4, p5, p7}, Loa/a;->h(Landroid/content/Context;Landroid/content/Intent;Landroid/content/ServiceConnection;ILjava/util/concurrent/Executor;)Z
    ...
    .line 90
    iget-object p2, p0, Loa/a;->a:Ljava/util/concurrent/ConcurrentHashMap;

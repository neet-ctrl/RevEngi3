...
.method public a(Landroid/content/Context;Li4/h$c;Landroid/content/res/Resources;I)Landroid/graphics/Typeface;
    ...
    .line 46
    invoke-virtual {v3}, Li4/h$d;->d()Ljava/lang/String;
    ...
    .line 86
    .line 87
    invoke-virtual {p0, p2, p4}, Lj4/w;->i(Landroid/graphics/fonts/FontFamily;I)Landroid/graphics/fonts/Font;
...
.method public b(Landroid/content/Context;Landroid/os/CancellationSignal;[Lp4/i$b;I)Landroid/graphics/Typeface;
    ...
    .line 6
    :try_start_0
    invoke-virtual {p0, p2, p3, p1}, Lj4/w;->k(Landroid/os/CancellationSignal;[Lp4/i$b;Landroid/content/ContentResolver;)Landroid/graphics/fonts/FontFamily;
    ...
    .line 17
    .line 18
    invoke-virtual {p0, p1, p4}, Lj4/w;->i(Landroid/graphics/fonts/FontFamily;I)Landroid/graphics/fonts/Font;
...
.method public c(Landroid/content/Context;Landroid/os/CancellationSignal;Ljava/util/List;I)Landroid/graphics/Typeface;
    ...
    .line 12
    .line 13
    invoke-virtual {p0, p2, v0, p1}, Lj4/w;->k(Landroid/os/CancellationSignal;[Lp4/i$b;Landroid/content/ContentResolver;)Landroid/graphics/fonts/FontFamily;
    ...
    .line 36
    check-cast v4, [Lp4/i$b;

    .line 37
    .line 38
    invoke-virtual {p0, p2, v4, p1}, Lj4/w;->k(Landroid/os/CancellationSignal;[Lp4/i$b;Landroid/content/ContentResolver;)Landroid/graphics/fonts/FontFamily;
    ...
    .line 53
    :cond_2
    invoke-virtual {p0, v0, p4}, Lj4/w;->i(Landroid/graphics/fonts/FontFamily;I)Landroid/graphics/fonts/Font;
...
.method public h([Lp4/i$b;I)Lp4/i$b;
    .locals 0
...
.method public final i(Landroid/graphics/fonts/FontFamily;I)Landroid/graphics/fonts/Font;
    ...
    .line 32
    invoke-static {v0, v1}, Lj4/w;->n(Landroid/graphics/fonts/FontStyle;Landroid/graphics/fonts/FontStyle;)I
    ...
    .line 50
    invoke-static {v0, v4}, Lj4/w;->n(Landroid/graphics/fonts/FontStyle;Landroid/graphics/fonts/FontStyle;)I
...
.method public final j(Landroid/os/CancellationSignal;Lp4/i$b;Landroid/content/ContentResolver;)Landroid/graphics/fonts/Font;
    .locals 1

    .line 1
    invoke-virtual {p2}, Lp4/i$b;->i()Z
    ...
    .line 6
    .line 7
    invoke-virtual {p0, p2}, Lj4/w;->m(Lp4/i$b;)Landroid/graphics/fonts/Font;
    ...
    .line 12
    :cond_0
    invoke-virtual {p0, p1, p2, p3}, Lj4/w;->l(Landroid/os/CancellationSignal;Lp4/i$b;Landroid/content/ContentResolver;)Landroid/graphics/fonts/Font;
...
.method public k(Landroid/os/CancellationSignal;[Lp4/i$b;Landroid/content/ContentResolver;)Landroid/graphics/fonts/FontFamily;
    .locals 5
    ...
    .line 8
    .line 9
    invoke-virtual {p0, p1, v4, p3}, Lj4/w;->j(Landroid/os/CancellationSignal;Lp4/i$b;Landroid/content/ContentResolver;)Landroid/graphics/fonts/Font;
...
.method public final l(Landroid/os/CancellationSignal;Lp4/i$b;Landroid/content/ContentResolver;)Landroid/graphics/fonts/Font;
    .locals 3
    ...
    .line 2
    :try_start_0
    invoke-virtual {p2}, Lp4/i$b;->e()Landroid/net/Uri;
    ...
    .line 52
    invoke-virtual {p2}, Lp4/i$b;->f()Ljava/lang/String;
...
.method public m(Lp4/i$b;)Landroid/graphics/fonts/Font;
    .locals 1

...
.method public constructor <init>(Landroid/content/Context;Landroid/view/Display;Lio/flutter/plugin/platform/i;Lio/flutter/plugin/platform/a;ILandroid/view/View$OnFocusChangeListener;)V
    ...
    .line 8
    invoke-static {p1, p3}, Lio/flutter/plugin/platform/SingleViewPresentation$d;->b(Lio/flutter/plugin/platform/SingleViewPresentation$d;Lio/flutter/plugin/platform/i;)Lio/flutter/plugin/platform/i;
...
.method public getView()Lio/flutter/plugin/platform/i;
    ...
    .line 2
    .line 3
    invoke-static {v0}, Lio/flutter/plugin/platform/SingleViewPresentation$d;->a(Lio/flutter/plugin/platform/SingleViewPresentation$d;)Lio/flutter/plugin/platform/i;
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    .line 18
    .line 19
    invoke-static {p1}, Lio/flutter/plugin/platform/SingleViewPresentation$d;->c(Lio/flutter/plugin/platform/SingleViewPresentation$d;)Lio/flutter/plugin/platform/t0;
    ...
    .line 26
    .line 27
    new-instance v0, Lio/flutter/plugin/platform/t0;
    ...
    .line 33
    invoke-direct {v0, v1}, Lio/flutter/plugin/platform/t0;-><init>(Landroid/content/Context;)V

    .line 34
    .line 35
    .line 36
    invoke-static {p1, v0}, Lio/flutter/plugin/platform/SingleViewPresentation$d;->d(Lio/flutter/plugin/platform/SingleViewPresentation$d;Lio/flutter/plugin/platform/t0;)Lio/flutter/plugin/platform/t0;
    ...
    .line 40
    .line 41
    invoke-static {p1}, Lio/flutter/plugin/platform/SingleViewPresentation$d;->e(Lio/flutter/plugin/platform/SingleViewPresentation$d;)Lio/flutter/plugin/platform/d1;
    ...
    .line 60
    .line 61
    new-instance v1, Lio/flutter/plugin/platform/d1;

    .line 62
    .line 63
    invoke-static {v0}, Lio/flutter/plugin/platform/SingleViewPresentation$d;->c(Lio/flutter/plugin/platform/SingleViewPresentation$d;)Lio/flutter/plugin/platform/t0;
    ...
    .line 67
    invoke-direct {v1, p1, v2}, Lio/flutter/plugin/platform/d1;-><init>(Landroid/view/WindowManager;Lio/flutter/plugin/platform/t0;)V

    .line 68
    .line 69
    .line 70
    invoke-static {v0, v1}, Lio/flutter/plugin/platform/SingleViewPresentation$d;->f(Lio/flutter/plugin/platform/SingleViewPresentation$d;Lio/flutter/plugin/platform/d1;)Lio/flutter/plugin/platform/d1;
    ...
    .line 91
    .line 92
    invoke-static {v1}, Lio/flutter/plugin/platform/SingleViewPresentation$d;->e(Lio/flutter/plugin/platform/SingleViewPresentation$d;)Lio/flutter/plugin/platform/d1;
    ...
    .line 97
    .line 98
    invoke-direct {p1, v0, v1, v2}, Lio/flutter/plugin/platform/SingleViewPresentation$c;-><init>(Landroid/content/Context;Lio/flutter/plugin/platform/d1;Landroid/content/Context;)V
    ...
    .line 184
    .line 185
    invoke-static {v1}, Lio/flutter/plugin/platform/SingleViewPresentation$d;->c(Lio/flutter/plugin/platform/SingleViewPresentation$d;)Lio/flutter/plugin/platform/t0;
